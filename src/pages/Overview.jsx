...
{course.modules.map((module) => {
  ...
  return (
    <div key={module.moduleNumber} className='my-6 w-full border border-gray-200 rounded overflow-hidden'>
      <div
      ...
      >
        {module.files.map((file) => (
          ...
          >
            ...
            <p className='font-semibold hover:underline cursor-pointer'>{file.name}</p>
          </div>
        ))}
      </div>
    </div>
        ...
        <button className="w-full gap-1  items-center bg-[#F2F4F4] hover:bg-gray-200 duration-300 transition-all text-gray-700 cursor-pointer flex justify-start border-gray-300 border  py-3 px-4 rounded">
          <IoStatsChartSharp/>View Course Stream
        </button>
        <button className="w-full gap-1 items-center bg-[#F2F4F4] hover:bg-gray-200 transition-all duration-300 text-gray-700 cursor-pointer flex justify-start border-gray-300 border py-3 px-4 rounded">
          <RxCross1/>Drop this Course
        </button>
        <button className="w-full gap-1  items-center bg-[#F2F4F4] hover:bg-gray-200 duration-300 transition-all text-gray-700 cursor-pointer flex justify-start border-gray-300 border  py-3 px-4 rounded">
          <CiCalendarDate className='text-2xl'/>View Course Calender
        </button>
        <button className="w-full gap-1  items-center bg-[#F2F4F4] hover:bg-gray-200 duration-300 transition-all text-gray-700 cursor-pointer flex justify-start border-gray-300 border  py-3 px-4 rounded">
      ...
      <h2 className="text-lg  text-gray-900 mb-2 border-gray-300 border-b pb-1 font-semibold">Recent Feedback</h2>
